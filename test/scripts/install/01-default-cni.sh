...
function install_cilium() {
    CILIUM_HELM_OPTIONS=" --set tunnel=disabled \
                         --set autoDirectNodeRoutes=true "

    case ${IP_FAMILY} in
      ipv4)
          CILIUM_HELM_OPTIONS+=" --set ipam.operator.clusterPoolIPv4PodCIDR=172.20.0.0/16 \
                                 --set ipv4NativeRoutingCIDR=172.20.0.0/16 \
                                 --set ipv4.enabled=true \
                                 --set ipv6.enabled=false "
        ;;
      ipv6)
          CILIUM_HELM_OPTIONS+=" --set ipam.operator.clusterPoolIPv6PodCIDR=fc00:172:18::/112 \
                                 --set ipv6NativeRoutingCIDR=fc00:172:18::/112 \
      ...
      dual)
          CILIUM_HELM_OPTIONS+=" --set ipam.operator.clusterPoolIPv4PodCIDR=172.20.0.0/16 \
                                 --set ipv4NativeRoutingCIDR=172.20.0.0/16 \
                                 --set ipam.operator.clusterPoolIPv6PodCIDR=fc00:172:18::/112 \
                                 --set ipv6NativeRoutingCIDR=fc00:172:18::/112
                                 --set ipv4.enabled=true \
                                 --set ipv6.enabled=true "
        ;;
